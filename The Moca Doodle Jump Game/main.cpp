...
void StartGameFunction() {
    ...
    texture.loadFromFile("images/background.png"); //เก็บค่าไฟล์ภาพไว้ใน texture
    ...
    {  
        ...
        if (sumy > 1000) { //เเวลาในการเปลี่ยนฉาก ตาม place//
            sumy = 0;
...

            {
                ...
                if (sumy  > 1000) {
                    ...
                    while (window.isOpen())
                    {
                        ...
                        //--------------------------------------------------------เปลี่ยน Background 4---------------------------------------------------//
                        if (sumy > 1000) { //เเวลาในการเปลี่ยนฉาก ตาม place//
                            sumy = 0;
                            texture.loadFromFile("images/background3.png"); //เก็บค่าไฟล์ภาพไว้ใน texture
                            ////////////////////////////////////////////////////////////////////////
                            Sprite background1, background2;
                            background1.setTexture(texture);
                            background2.setTexture(texture);
                        ...
                        if (y < h)
                            for (int i = 0; i < 10; i++)
                            {
                                y = h;
                                plat[i].y = plat[i].y - dy;
                                if (plat[i].y > 533) { plat[i].y = 0; plat[i].x = rand() % 400;  sum = sum + 1;
                                }
